...
public class ControladorEnvios {
    ...
    public void cancelarPedido(String idPedido) {
        // Variable local para almacenar el pedido encontrado (evita compartir estado entre metodos)
    ...
    public void despacharPedido(String idPedido) {
        // Variable local para almacenar el pedido encontrado
        Pedido pedidoEncontrado = null;
    ...
    // Metodo Getter contiene los Pedidos vigentes ( despues de discriminar los datos )
    public ArrayList<Pedido> getPedidosVigentes() {
        return pedidos;
    }
